...
void CRenderer::Render_UI(LPDIRECT3DDEVICE9& pGraphicDev)
{
    ...
    DWORD oldCull, oldZEnable, oldZWrite, oldAlphaBlend;
    pGraphicDev->GetRenderState(D3DRS_CULLMODE, &oldCull);
    pGraphicDev->GetRenderState(D3DRS_ZENABLE, &oldZEnable);
    ...
    pGraphicDev->SetRenderState(D3DRS_CULLMODE, oldCull);
    pGraphicDev->SetRenderState(D3DRS_ZENABLE, oldZEnable);
